...
export default function GaleriPage() {
  ...
  return (
    <PublicLayout
      title={lang === 'id' ? 'Galeri Foto' : 'Photo Gallery'}
      subtitle={lang === 'id' ? 'Dokumentasi kegiatan Pengadilan Agama Penajam' : 'Documentation of Penajam Religious Court activities'}
    >
