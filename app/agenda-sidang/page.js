        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 bg-[#d4a017]/20 rounded-xl flex items-center justify-center">
              <CalendarDays className="w-5 h-5 text-[#d4a017]" />
            </div>
            ...
            {Object.entries(grouped).sort(([a],[b]) => a.localeCompare(b)).map(([date, agendas]) => (
              <div key={date}>
                <div className="flex items-center gap-3 mb-3">
                  <div className="bg-[#1b5e20] text-white px-3 py-1.5 rounded-lg text-sm font-bold">
                    ...
                    <div key={item.id} className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex gap-4">
                          <div className="flex flex-col items-center justify-center w-14 h-14 bg-[#1b5e20]/5 rounded-xl flex-shrink-0">
                            <span className="text-[#1b5e20] font-bold text-lg leading-none">{item.waktuSidang?.slice(0,5)}</span>
                            <span className="text-[#1b5e20]/50 text-[10px]">WITA</span>
                          </div>
                          <div>
                            <p className="font-bold text-[#1b5e20] text-base">{item.nomorPerkara}</p>
