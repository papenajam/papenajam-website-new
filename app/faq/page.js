  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      >
        ...
        <span className={`text-[#d4a017] flex-shrink-0 text-xl font-bold leading-none transition-transform duration-200 ${open ? 'rotate-45' : ''}`}>+</span>
      </button>
      {open && (
    ...
    >
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="bg-[#1b5e20] rounded-2xl p-6 text-center">
          ...
          <a href="/pengaduan" className="inline-flex items-center gap-2 bg-[#d4a017] hover:bg-[#b88010] text-white font-semibold px-6 py-3 rounded-xl transition-colors">
